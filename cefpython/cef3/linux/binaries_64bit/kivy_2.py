...
from cefkivy.popup import PopupController
...
class ClientHandler():
    ...
    def OnBeforePopup(self, pyBrowser, pyFrame, pyTargetUrl,
                    pyTargetFrameName, popupFeatures, pyWindowInfo,
                    client, settings,
                    pyNoJavascriptAccess):
        #self.browser_widget.dispatch("on_before_popup", *kwargs)
        print "on POPUP", pyWindowInfo
        pyWindowInfo[0] = self.browser_widget.popup.popup.browser
        return False
