...
binary_distrib_cef_binary_3_1650_1639_linux64_cefclient_gyp_cefclient_target_copies = $(builddir)/files/binding.html $(builddir)/files/dialogs.html $(builddir)/files/domaccess.html $(builddir)/files/localstorage.html $(builddir)/files/logo.png $(builddir)/files/osr_test.html $(builddir)/files/other_tests.html $(builddir)/files/performance.html $(builddir)/files/performance2.html $(builddir)/files/transparency.html $(builddir)/files/window.html $(builddir)/files/xmlhttprequest.html $(builddir)/cef.pak $(builddir)/devtools_resources.pak $(builddir)/locales $(builddir)/libcef.so $(builddir)/libffmpegsumo.so
...
CFLAGS_Debug := \
	...
	-pipe \
	-fPIC \
	$(shell pkg-config --cflags gmodule-2.0 gtk+-2.0 gthread-2.0 gtkglext-1.0 gtk+-unix-print-2.0) \
	-O0 \
	-g
...
$(OBJS): | $(obj).target/libcef_dll_wrapper.a $(obj).target/gtk.stamp

# Make sure our actions/rules run before any of us.
$(OBJS): | $(binary_distrib_cef_binary_3_1650_1639_linux64_cefclient_gyp_cefclient_target_copies)
...
$(builddir)/cefclient: | $(binary_distrib_cef_binary_3_1650_1639_linux64_cefclient_gyp_cefclient_target_copies)

# Preserve order dependency of special output on deps.
$(binary_distrib_cef_binary_3_1650_1639_linux64_cefclient_gyp_cefclient_target_copies): | $(obj).target/libcef_dll_wrapper.a $(obj).target/gtk.stamp
...
LDFLAGS_Debug := \
	...
	-fPIC \
	-Wl,-rpath,. \
	$(shell pkg-config --libs-only-L --libs-only-other gmodule-2.0 gtk+-2.0 gthread-2.0 gtkglext-1.0 gtk+-unix-print-2.0)
...
LIBS := \
	 \
	$(BUILDTYPE)/libcef.so \
	$(shell pkg-config --libs-only-l gmodule-2.0 gtk+-2.0 gthread-2.0 gtkglext-1.0 gtk+-unix-print-2.0)
